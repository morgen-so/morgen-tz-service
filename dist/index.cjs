...
var windowsZonesInverse = {
  ...
  "Europe/Berlin": "Romance Standard Time",
  ...
  "Asia/Riyadh": "E. Africa Standard Time",
  ...
  "Asia/Dubai": "Mauritius Standard Time",
...
function checkLuxonCompatibility() {
  const zones = import_moment_timezone.default.tz.names();
