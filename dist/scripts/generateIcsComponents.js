...
(async function () {
    ...
    allZones.forEach((zone) => {
        ...
        if (!block)
            throw new Error(`No ics block for ${zone}`);
    ...
    fs.writeFileSync("./src/generated/icsZones.ts", `${header}export const icsZones: Record<string, string> = ${JSON.stringify(icsZones, null, 2)}`);
})();
//# sourceMappingURL=generateIcsComponents.js.map